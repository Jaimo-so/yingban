...
- [第十阶段技术开发文档](第十阶段技术开发文档.md)
- [第十一阶段技术开发文档](第十一阶段技术开发文档.md)
...
当前共 50 项测试。原有 49 项意义继续覆盖；第十一阶段新增 1 项契约测试，验证普通进入生成新会话、历史恢复必须显式触发、历史按电影命名、旧版草稿可迁移、本机最多保留最近 40 条消息，以及历史列表和删除确认入口存在。
...
- 对安全分类与回应做专业评审和系统评测；
- 接入合规电影数据源并建立数据质量监控；
- 增加跨进程持久队列、供应商账单对账、测试账户指标排除和更完整端到端测试；
